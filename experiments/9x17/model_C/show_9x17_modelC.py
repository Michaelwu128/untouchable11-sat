...
BOARD_H = 9
BOARD_W = 17
SOLUTION_FILE = 'solution_9x17_modelC.txt'
PLACEMENTS_FILE = 'placements_9x17_hybrid_amo.txt'
...
def main():
    ...
    if use_color:
        print("\n(如果顏色顯示為亂碼，請嘗試使用 `python show_9x17_modelC.py --no-color` 指令執行)")
    else:
        print("\n(您可以嘗試執行 `python show_9x17_modelC.py` 來查看彩色版本)")
