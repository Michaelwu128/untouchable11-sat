...
BOARD_H = 10
BOARD_W = 15
SOLUTION_FILE = 'solution_10x15_modelC.txt'
PLACEMENTS_FILE = 'placements_10x15_hybrid_amo.txt' # (請確認這是您產生的對照表名稱)
...
def main():
    ...
    if use_color:
        print("\n(如果顏色顯示為亂碼，請嘗試使用 `python3 show_10x15_modelC.py --no-color` 指令執行)")
    else:
        print("\n(您可以嘗試執行 `python3 show_10x15_modelC.py` 來查看彩色版本)")
