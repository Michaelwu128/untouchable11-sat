...
BOARD_H = 12
BOARD_W = 12
SOLUTION_FILE = 'solution_12x12_modelC_symmetry.txt'
PLACEMENTS_FILE = 'placements_12x12_final.txt' # (請確認這是您產生的對照表名稱)
...
def main():
    ...
    if use_color:
        print("\n(如果顏色顯示為亂碼，請嘗試使用 `python3 show_12x12_modelC_symmetry.py --no-color` 指令執行)")
    else:
        print("\n(您可以嘗試執行 `python3 show_12x12_modelC_symmetry.py` 來查看彩色版本)")
